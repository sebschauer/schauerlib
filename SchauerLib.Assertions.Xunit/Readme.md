# Sebschauer.SchauerLib.Assertions.Xunit


## What it is

This nuget contains some Xunit 3 Assert extensions for handling multiple assertions which depend on each other's assertion result:
